...
Version: 0.2
Author: Ravi Shakya
Description: Flexible slide to top accordion is a accordion with unlimited content scrolling in the post/post types with image gallery having lightbox.
*/  
...
function accordion_function() {
    ...
    if(empty($tabs_content)):
        ...
        echo '<tr>';
            ...
            echo '<input type="text" name="accordion_title_0" value="" class="widefat tab_name" placeholder="Title"/>';
            ...
            echo '<textarea name="accordion_content_0" value="" class="widefat tab_content" placeholder="Content"/></textarea>';
            echo '</td>';
        echo '</tr>';
        echo '</table>';
		...
		foreach($tabs_content as $key => $values){
			echo '<tr>';
				echo '<td class="first_tab">';
				echo '<div class="tabs_">';
				echo '<a href="javascript:void(0)" title="Add Tab Above" class="add_tab_above"><img width="30" src="' . plugins_url( 'images/add-button.png', __FILE__ ) . '">';
				echo '</a>';
				echo '<a href="javascript:void(0)" title="Delete This Tab" class="delete_tab">';
				echo '<img width="30" src="' . plugins_url( 'images/button-remove.png', __FILE__ ) . '">';
				echo '</a>';
				echo '</div>';
				echo '</td>';
				echo '<td class="second_tab">';
...
function wpt_save_accordion_meta($post_id, $post) {
    ...
    if(isset($_POST['accordion_meta_noncename'])){
