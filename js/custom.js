...
//****************************************************************
	...
	jQuery(document).on('click','.add_more_tab',function(){
		...
		jQuery('.tabs_post').append('<tr>'+
		'<td class="first_tab">'+
			'<div class="tabs_">'+
				'<a href="javascript:void(0)" title="Add Tab Above" class="add_tab_above">'+
					'<img width="30" src="' + ajax_params.btn_add + '">'+
				'</a>'+
				'<a href="javascript:void(0)" title="Delete This Tab" class="delete_tab">'+
					'<img width="30" src="' + ajax_params.btn_remove + '">'+
				'</a>'+
			'</div>'+
		'</td>'+
		'<td class="second_tab">'+
			'<input type="text" name="accordion_title_' + add_one + '" value="" class="widefat tab_name" placeholder="Title"/>'+
			'<div for="upload_image" class="upload_image_accordion">'+
				'<div class="ajax_images">'+
				'</div>'+
				'<div class="images_preview_accordion" style="display:none;">'+
					'<img src="' + ajax_params.loading + '">'+
				'</div>'+
			'</div>'+
			'<input id="upload_image_button" class="button" type="button" value="Upload Images" />'+
			'<textarea name="accordion_content_' + add_one + '" value="" class="widefat" placeholder="Content"/>'+
			'</textarea>'+
		'</td>'+
		'</tr>');
...
jQuery(document).on('click','.add_tab_above',function(){
    ...
    jQuery(this).closest('tr').before( '<tr>'+
	'<td class="first_tab">'+
		'<div class="tabs_">'+
			'<a href="javascript:void(0)" title="Add Tab Above" class="add_tab_above">'+
				'<img width="30" src="' + ajax_params.btn_add + '">'+
